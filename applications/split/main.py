"""
Split Service — FastAPI application entry point.

No REST API beyond health checks. The service is driven entirely by
RabbitMQ consumption: it listens for image.new events, splits images
into 16 fragments, and publishes fragment.task messages.
"""
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Split service stopped")


app = FastAPI(
    title="Sobel Split",
    description="Image splitting service — consumes image.new, publishes fragment.task",
    lifespan=lifespan,
)
